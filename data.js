const database = [
    ...
    // =========================================================================
    {
        ...
        questions: [
            ...
            {
                q: "Tỷ lên các loại ung thư ít hơn thế giới",
                options: [
                    "K thực quản",
                    "K vòm",
                    "K lympho",
            ...
            },
            {
                ...
                options: [
                    ...
                    "Tỉ lệ mới mắc đặc trưng theo nhóm tuổi của hầu hết các vị trí ung thư ở nam thường cao hơn ở nửa",
            ...
            {
                q: "Yếu tố quan trọng nhất xác định nguy cơ gây ung",
                options: [
                    "Tuổi",
                    "Giới tính",
                    "Địa lý",
            ...
            {
                q: "tỷ lệ mới mắc được tính bằng",
                options: [
                    "số ca mới mắc trong quần thể trên 10.000 dân tính trong 1 năm",
                    "số ca mới mắc trong quần thể trên 100.000 dân tính trong 1 năm",
                    "số ca mới mặc trong quần thể trên 1.000 dân tính trong 1 năm",
                    "số ca mới mắc trong quần thể trên 1.000.000 dân tính trong 1 năm"
                ],
                correctIndex: 1
            },
            {
            ...
            {
                q: "Tỉ lệ tử vong tỉnh trên bao nhiêu người mỗi năm",
                options: [
                    "100 000",
                    "1 000 000",
                    "10 000",
            ...
            {
                q: "Trong các loại ung thư ở nữ giới, ung thư vú xếp ở vị trí:",
                options: [
                    "Thứ nhất",
                    "Thứ 2",
                    "Thú 3",
            ...
            },
            {
                q: "Tỷ lệ tử vong:",
                options: [
                    "Được tính tính bằng số ca tử vong trên 100.000 dân mỗi năm",
                    "Được tính tính bằng số ca tử vong trên 10.000 dân mỗi năm",
                    "Được tính tính bằng số ca tử vong trên 1.000.000 dân mỗi năm",
                    "Được tính tính bằng số ca tử vong trên 1.000 dân mỗi năm"
                ],
                correctIndex: 0
            },
            {
